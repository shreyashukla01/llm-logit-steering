# llm-logit-steering
An exploratory project examining how vector-based logit steering affects the child-suitability of outputs from open-source language models.
...
## Overview
> Focus: Evaluating alignment robustness under decoding-time perturbations
...
- Evaluated responses across ~355 prompts filtered from OR-BenchHard
...
- No clear relationship between model size and robustness to steering: the 8B model shows broader degradation, while the distilled 8B shows more contained effects despite lower baseline suitability, indicating differences across model variants beyond scale  
